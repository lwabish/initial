...
function themeConfig($form) {
	...
	$ShowLinks = new Typecho_Widget_Helper_Form_Element_Checkbox('ShowLinks', array('footer' => _t('页脚'), 'sidebar' => _t('侧边栏'),'header' => _t('header')), array('sidebar'), _t('显示链接模块'));
	$form->addInput($ShowLinks->multiMode());

	$ShowWhisper = new Typecho_Widget_Helper_Form_Element_Checkbox('ShowWhisper', array('index' => _t('首页'), 'sidebar' => _t('侧边栏'), 'header' => _t('header')), array('sidebar'), _t('显示轻语模块'));
